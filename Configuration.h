...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // (measured after M106 S255 with M303 E0 S210 C8)
    ...
    #define DEFAULT_Kp_LIST {  36.56,  36.56 }
    #define DEFAULT_Ki_LIST {   4.29,   4.29 }
    #define DEFAULT_Kd_LIST {  77.88,  77.88 }
  #else
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 221.02
  #define DEFAULT_bedKi 43.52
  #define DEFAULT_bedKd 748.39
